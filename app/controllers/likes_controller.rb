class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      ...
      redirect_to("/photos/#{the_like.photo_id}", { :notice => "Like failed to create successfully." })
    end
  end
...
#the_like.fan_id = params.fetch("query_fan_id")
#the_like_fan = the_like.fan_id

#the_like.photo_id = params.fetch("query_photo_id")
#the_like_photo = the_like.photo_id

#the_like = Like.where({ :photo_id => the_like_photo }).where({ :fan_id => the_like_fan }).at(0)
